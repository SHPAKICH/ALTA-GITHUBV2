...
function the_conference_admin_notice(){
    ...
    $dismissnonce   = wp_create_nonce( 'the_conference_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p class="dismiss-link"><strong><a href="?the_conference_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss', 'the-conference' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function the_conference_update_admin_notice(){
    ...
    if ( isset( $_GET['the_conference_admin_notice'] ) && $_GET['the_conference_admin_notice'] = '1' && wp_verify_nonce( $_GET['_wpnonce'], 'the_conference_admin_notice' )) {
